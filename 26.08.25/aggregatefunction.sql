...
select department from worker union all  select  department from worker;

#sql case statement 
select first_name, salary,
case when  salary >= 300000 then 'Rich' when salary >= 100000 and salary <= 300000 then 'Middle' 
Else 'Poor'
